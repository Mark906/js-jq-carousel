$(document).ready(function() {
    ...
    $('.next i').click(function() {
        ...
        if(img_corrente.next('img').length) {
            ...
            pallino_corrente.next('.indicatori_immagine i').removeClass('far').addClass('fas');
        } else {
    ...
    $('.prev i').click(function() {
        ...
        if(img_corrente.prev('img').length) {
            ...
            // assegno la classe fas al pallino successivo
            pallino_corrente.prev('.indicatori_immagine i').removeClass('far').addClass('fas');
        } else {
            ...
            $('.indicatori_immagine i:last-child').removeClass('far').addClass('fas');
        }
    });
